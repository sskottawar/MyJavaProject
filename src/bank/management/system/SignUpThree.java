...
public class SignUpThree extends JFrame implements ActionListener{
	...
	SignUpThree(String formno){
		...
		c2= new JCheckBox("International Banking");
		...
		c7= new JCheckBox("I here by declares that above entered details are correct to the best of my knowledge.");
		...
		submit.setBounds(500,580,100,25);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(ae.getSource() == submit) {
			...
			String cardnumber = "" + Math.abs((random.nextLong() %900000000L) +504039600000000L);
